...
| Scheduler mechanics must be proven synthetically before production scheduling is considered | Task028C/D docs, `completion_monitor_schedule_drill.py`; `de24e14`, `e3758e4` | Offline harness exists; the real temporary macOS drill, evidence review and any later production-schedule design remain separate gates |
...
| RFC decision | Status at `e3758e4` | Boundary / consequence |
|---|---|---|
